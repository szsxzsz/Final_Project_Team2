...
<h1> 자유게시판 작성 </h1>
<div class="box box-warning" style="margin-left:150px; width:800px;">
		...
		<form role="form" action="/freeboardwrite" enctype="multipart/form-data" method="post">
			...
			<div class="input-group">
				<span class="input-group-addon"> 작성자 </span> 
					<input type="text" class="form-control" name="b_writer" value="${nick }" readonly style="width:700px">
			</div>
			<br>
			<div class="form-group">
				<label>글 제목</label> 
					<input type="text" class="form-control" placeholder="제목을 작성해주세요" name="b_title" style="width:700px">
			</div>
			<div class="form-group">
				<label>글 내용</label>
				<textarea class="form-control" rows="3" placeholder="내용을 입력해주세요" name="b_content" style="width:700px"></textarea>
			</div>
