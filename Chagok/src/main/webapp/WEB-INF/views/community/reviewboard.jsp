    ...
    <div class="board_wrap">
        ...
        <strong>챌린지 후기 게시판</strong>
         ...
         <div class="board_list">
             <div class="top">
             	<th>
                 <div class="num" style="padding-right: 10px; width:100px; padding-left: 10px;">글번호</div>
             	</th>
             	<th>
                 <div class="num" style="padding-left:10px; width: 150px;">카테고리</div>
                </th>
             	<th>
                 <div class="title" style="width: 170px;">챌린지 기간</div>
                </th>
             	<th>
                 <div class="num" style="width: 300px;">챌린지 제목</div>
                </th>
<!--              	<th> -->
<!--                  <div class="num" style="width:130px;">성공 인원</div> -->
<!--                 </th> -->
             	<th>
                 <div class="num" style="padding-left:25px; width:130px;">작성자</div>
                </th>
             	<th>
                 <div class="date" style="padding-left:25px; width:130px;">작성일</div>
                </th>
         	</div>
...
<%-- 			<fmt:parseNumber value="${c_end.time / (1000*60*60*24)}" integerOnly="true" var="endTime" scope="request" /> --%>
		...
		<fmt:parseNumber var="boardno" value="${boardno }" type="number" />
         ...
         <c:forEach items="${boardList2 }" var="boardList2">
                <div>
                	<td>
                   		<div class="num" style="padding-right: 10px; width:100px; padding-left: 10px;">${boardno }</div>
                	</td>
                	<td>
                    	<div class="num" style="padding-left:10px; width: 150px;">[${sort }]</div>
                	</td>
                	<td>
	                    <div class="num" style="width: 170px;">
	                    	 ${boardList2.c_period } 주
	                    </div>
                	</td>
                	<td>
	                    <div class="title" style="width: 300px;">
	                    	<a href="http://localhost:8080/reviewcontent?bno=${boardList2.bno }&cno=${boardList2.cno}">${boardList2.b_title }</a>
	                    </div>
                	</td>
<!--                 	<td> -->
<%-- 	                    <div class="title" style="width:130px;">${Success } / ${CList }</div> --%>
<!--                 	</td> -->
                	<td>
	                    <div class="num" style="padding-left:25px; width:130px;">${boardList2.b_writer}</div>
                	</td>
                	<td>
	                    <div class="date" style="padding-left:25px; width:130px;"><b><fmt:formatDate value="${boardList2.b_date }" pattern="yyyy-MM-dd"/></b></div>
                	</td>
