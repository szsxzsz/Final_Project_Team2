...
<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt"%>
		...
		<header class="header">
			<div class="header__top">
				...
				<div class="header__meta">
					<span class="header__date">[${vo2.ct_top}]</span> ${vo.c_title }
					<span class="header__serial">${vo.c_title }</span>
			...
			<div class="header__greeting">
				<span class="header__name">${vo.c_title }</span>
				 <span class="header__count">🎉축하합니다! 성공적으로 챌린지를 마치셨습니다!</span> 
		...
		<section class="cart">
			...
			<ol class="list">
				<li class="list__item">
					...
					<span class="list__price">${vo.size() }</span></li>
				<li class="list__item">
					<span class="list__name">
						성공 인원
					</span>
				...
				<li class="list__item">
					<span class="list__name">
						모인 꿀머니
					</span> <span class="list__price"></span></li>
			</ol>
			<hr class="cart__hr" />
	...
	<button class="button" type="button" onclick="location.href='/chagok/commumain';">메인으로 가기</button>
