...
<%-- 		<p class="fst-italic">챌린지가 (${현재날짜 - vo.c_start  포맷팅해서 변환된걸 가져와야해})일 후에 시작됩니다!</p> --%>
		<div class="row">
			<div class="col-lg-6">
...
<!--               </div> -->
		...
		<p class="fst-italic">총 (${vo.c_total })번을 (${vo.c_freq })일동안 (${vo.c_amount })원씩 저축하는 조건이 있습니다.</p>
        <div class="form-group">
           	<span><strong>챌린지 설명</strong></span>
<!--             <textarea class="form-control" rows="3"></textarea> -->
				 <textarea class="form-control" rows="3" readonly>${vo.c_content }</textarea>
        </div>
